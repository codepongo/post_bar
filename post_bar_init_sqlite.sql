...
CREATE TABLE `category` (
  ...
  `name` varchar(45) UNIQUE NOT NULL /*COMMENT '分类名'*/,
...
CREATE TABLE `comment` (
  ...
  `post_id` INTEGER DEFAULT NULL/* COMMENT '帖子id'*/,
  `content` text/* COMMENT '内容'*/,
  `time` INTEGER DEFAULT NULL/* COMMENT '评论时间'*/,
...
CREATE TABLE `money` (
  `id` INTEGER PRIMARY KEY NOT NULL,
  `user_id` INTEGER NOT NULL,
  `money_type_id` INTEGER NOT NULL/* COMMENT '收支类型'*/,
  `length` INTEGER NOT NULL DEFAULT '0'/* COMMENT '长度'*/,
  `amount` float NOT NULL DEFAULT '0'/* COMMENT '金额'*/,
  `balance` float NOT NULL DEFAULT '0'/* COMMENT '余额'*/,
  `foreign_id` INTEGER DEFAULT '0'/* COMMENT '帖子/评论/用户 id'*/,
  --PRIMARY KEY(`id`),
...
)/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='财富收支表'*/;
...
CREATE TABLE `money_option` (
  ...
  --PRIMARY KEY(`id`),
  --KEY `key` (`key`)
)/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='全站配置'*/;
...
CREATE TABLE `money_type` (
  ...
  `comment` varchar(50) DEFAULT NULL--,
  --PRIMARY KEY(`id`)
)/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='财富的获取或支出类型';
...
CREATE TABLE `node` (
  ...
  `name` varchar(45) UNIQUE NOT NULL/* COMMENT '节点名'*/,
  `display_name` varchar(45) NOT NULL/* COMMENT '显示名'*/,
...
)/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='所有节点'*/;
...
CREATE TABLE `notify` (
  ...
  `unread` tinyINTEGER NOT NULL DEFAULT '1',
  --PRIMARY KEY(`id`),
...
CREATE TABLE `post` (
  `id` INTEGER PRIMARY KEY NOT NULL,
  `user_id` INTEGER DEFAULT NULL,
  `node_id` INTEGER DEFAULT NULL/* COMMENT '节点id'*/,
  `title` text NOT NULL/* COMMENT '标贴'*/,
  `content` text NOT NULL,
  `time` INTEGER NOT NULL/* COMMENT '发帖时间'*/,
  `views` INTEGER DEFAULT '0'/* COMMENT '围观数'*/,
  `comments` INTEGER DEFAULT '0'/* COMMENT '评论数'*/,
  `thanks` INTEGER NOT NULL DEFAULT '0',
  `last_update` INTEGER DEFAULT NULL/* COMMENT '最后更新时间（发帖，评论）'*/,
  --PRIMARY KEY(`id`),
...
)/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='所有帖子'*/;
...
CREATE TABLE `user` (
  ...
  `email` varchar(45) UNIQUE NOT NULL/* COMMENT '邮箱'*/,
  `password` varchar(45) DEFAULT NULL/* COMMENT '密码'*/,
  `gender` INTEGER DEFAULT '1'/* COMMENT '性别'*/,
  `regist_time` INTEGER DEFAULT NULL/* COMMENT '注册时间'*/,
  `signature` char(100) DEFAULT NULL/* COMMENT '签名'*/,
  `avatar` varchar(45) DEFAULT NULL/* COMMENT '头像'*/,
  `outsite_link` text/* COMMENT '主页'*/,
  `posts` INTEGER DEFAULT '0'/* COMMENT '发表帖子数'*/,
  `money` float DEFAULT '2000'/* COMMENT '财富'*/,
  `node_favs` INTEGER DEFAULT '0'/* COMMENT '收藏节点数'*/,
  `post_favs` INTEGER DEFAULT '0'/* COMMENT '收藏帖子数'*/,
  `user_favs` INTEGER DEFAULT '0'/* COMMENT '关注成员数'*/,
  `auth` varchar(5) NOT NULL DEFAULT ''/* COMMENT '组合加密字符串'*/--,
  ----PRIMARY KEY(`id`),
  --UNIQUE --KEY `email_UNIQUE` (`email`),
  --UNIQUE --KEY `name_UNIQUE` (`name`)
)/*/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='用户'*/;
...
)/* ENGINE=InnoDBDEFAULT CHARSET=utf8 COMMENT='用户扩展表'*/;
